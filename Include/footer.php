<footer>
    <div class="footer-box">
        <li>
          <ul>
            <h2 class="footer-titre-box">Contact</h2>
          </ul>
          <ul>
            <p><i>8 rue d'Hozier,<i>
            <p>
          </ul>
          <ul>
            <p><i>13002, Marseille</i></p>
          </ul>
          <ul>
            <p>04 84 89 43 69</p>
          </ul>
          <ul>
            <p>contact@laplateforme.io</p>
          </ul>
        </li>
      </div>
      ...
      <div class="footer-box">
        <li>
          <ul>
            <h2 class="footer-titre-box">Retrouvez notre projet réservation de salle sur Github </h2>
          </ul>
          <ul>
